...
pub const DiagnosticError = error{
    ...
    ConversionPremiseBinderNotCovered,
...
fn compilerErrorSummary(err: DiagnosticError) []const u8 {
    return switch (err) {
        ...
        error.ConversionPremiseBinderNotCovered => t("err_ConversionPremiseBinderNotCovered"),
        ...
        error.VariableAfterHypothesis => t("err_VariableAfterHypothesis"),
        ...
        error.DuplicateInfixToken => t("err_DuplicateInfixToken"),
